...
@RequiredArgsConstructor // final 필드가 존재한다면 그것을 초기화 해 주는 생성자.
...
//	}
//	@RequiredArgsConstructor이 위에 것을 대신한다.
	...
	public String register(ScoreRequestDTO dto) {
		...
		/*
		  	...
		  	갱신된 목록을 불러오는 요청이 다시금 들어올 수 있도록 유도를 하자
		  	-> sendRedirect()
		 ...
		 */
		return "redirect:/score/list"; //스프링의 redirect 1.로 다시 들어감
	}
	
	// 3. 성적 정보 상세 조회 요청
	@GetMapping("/detail") //a태그는 get방식
