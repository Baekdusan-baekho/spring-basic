...
public class WeatherService {
	...
	public void getShortTermForecast(String area1, String area2) {
		...
		try {
		    ...
		    urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=uoH9m%2Fk8T1YBUBnnXwkDD%2BlibVfKuO9tofNMmP4cOSjlLUzDgSRXo9w1qkkHIirbo7rS3PZC9RlVmfaWT8S5wg%3D%3D"); /*Service Key*/
